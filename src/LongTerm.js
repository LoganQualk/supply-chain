    ...
    return (
        <div className="content">
            ...
            <p>
                ...
                There are multiple ways to do it, but none of them are easy.  With regards to computing technologies, components
                are often manufactured in other countries.  Thus, in order to fix their supply chain, global production and shipping
                ...
                lead to unsafe working conditions, and further spikes in Covid, leading to even worse supply chain issues.
            </p>
            ...
            <div className="imageContentLeft">
                <div>
                    <p>
                        ...
                        and then be able to remove the restrictions altogether, without risk of eventually reinstating them.  However, this is
            ...
            <p>
                ...
                All we can do is hope that there are no more setbacks, as it doesn't seem like it will be fixed anytime soon.
            </p>
            ...
            <div className="imageContentRight">
                ...
                <p>
                    ...
                    these problems in order to make sure they don't happen again.  Covid-19 is likely not the last pandemic the world will ever
                    experience.  Thus, when the next pandemic hits, measures need to be in place that ensure the supply chain
                    doesn't fall apart again.
                </p>
            </div>
            <p>
                ...
                of manufacturers, sellers, and shipping networks, as soon as some of the individual parts began to have trouble, the supply chain as
                a whole began to break down as well.  Thus, these issues are likely to reoccur in the future, but if we are proactive in preparing for them,
                we will likely be able to reduce the negative impact. By making our supply chain much more transilient, we will be able to
                easily adapt to any problems, including another pandemic.  Thus, computing technology shortages will hopefully become a thing of the past, and 
                no longer affect society so heavily.
            </p>
        </div>
    );
}
